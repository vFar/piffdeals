...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2024 at 09:43 AM
...
--
-- Constraints for table `log_files`
--
ALTER TABLE `log_files`
  ADD CONSTRAINT `log_files_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
