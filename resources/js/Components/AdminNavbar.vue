        ...
        <nav
            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3 flex justify-between items-center">
                <div class="flex items-center">
                    ...
                    <img :src="getImageUrl('piffdeals_text_accent.svg')" alt="Logo" class="h-10 mr-2">
                    </Link>
                </div>
                ...
                <ul class="space-y-2 font-medium">
                    <ul class="space-y-2 font-medium">
                        ...
                        { highlighted: catalogDropdownOpen },
                                ...
                                <i :class="{ 'rotate-180': catalogDropdownOpen }"
                        ...
                        { highlighted: settingsDropdownOpen },
                                ...
                                <i :class="{ 'rotate-180': settingsDropdownOpen }"
                                    class="fas fa-chevron-down ml-auto"></i>
                            </button>
                            <ul v-show="settingsDropdownOpen" class="pl-4 space-y-1 bg-accent rounded-t-0 rounded-b-md">
                                ...
                                <li>
                                    <Link href="/profile" class="block p-2 rounded text-white uppercase ms-9">
                                    Profils
                                    </Link>
                                </li>
                            </ul>
