...
import { message } from "ant-design-vue"; // Importing message for notifications
...
const form = useForm({
    token: props.token,
    email: props.email, // This will pre-fill the email from the props
    password: "",
            ...
            >
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <button
                            class="bg-primary w-full rounded-xl hover:bg-gray-700 text-white py-2 hover:scale-105 duration-300 text-md uppercase"
