        ...
        <main class="flex-1 bg-whiter ml-64"> <!-- ml-64 to offset the width of the sidebar -->
            <section class="max-w-full mx-6 border border-gray-200 rounded-xl bg-whiter shadow-md py-3 px-3 pl-6 mb-8">
                <div class="flex justify-between items-center py-2">
                    <h1 class="uppercase font-semibold text-xl text-textColor">Klientu konti</h1>
                    ...
                    <div class="flex items-center">
                        ...
                        <Modal :show="createUserShow" @close="closeCreateUserModal">
                            <div class="pt-6">
                                <div class="flex items-center justify-between border-b mb-4">
                                    <h3 class="text-xl p-4 uppercase">Izveidot jaunu kontu</h3>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Vārds, uzvārds</th>
                                        <th scope="col" class="px-4 py-3">E-pasts</th>
                                        <th scope="col" class="px-4 py-3">Izveidots</th>
                                        <th scope="col" class="px-4 py-3">Modificēts</th>
                                        <th scope="col" class="px-4 py-3">
